...
const ListRoomType = ({ propertyId }) => {
  ...
  return (
    <div className="list-room-type-container">
      <h1 className="page-title">{t("choose_your_room")}</h1>
      <div className="search-section">
        ...
        >
          <Button className="guest-button">
            {guestCount} {t("guest")}{guestCount > 1 ? "s" : ""} - {roomCount} {t("room")}
            {roomCount > 1 ? "s" : ""}
          </Button>
        </Popover>
        <Button
      ...
      >
        <i className="fas fa-bed"></i> {t("proceed_booking")}
      </Button>
    </div>
  );
};
