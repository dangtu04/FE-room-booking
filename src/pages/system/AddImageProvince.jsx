...
const AddImageProvince = () => {
  ...
  return (
    <Form layout="vertical" onFinish={handleFinish}>
      <h1>{t("add_image_province.add_image_province")}</h1>

      <Form.Item
        label={t("add_image_province.select_province")}
        name="provinceId"
        rules={[{ required: true, message: "Vui lòng chọn tỉnh/thành!" }]}
      >
        <Select
          placeholder={t("add_image_province.select_province")}
      ...
      <Form.Item label={t("add_image_province.upload_new_image")}>
        <Upload {...uploadProps}>
          <Button icon={<UploadOutlined />}>
            {t("add_image_province.upload")}
          </Button>
        </Upload>
      </Form.Item>
