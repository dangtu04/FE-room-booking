...
const PropertyAmenityManage = () => {
  ...
  return (
    <>
      <h1>{t("property_amenity_manage.property_amenity_manage")}</h1>

      <Form layout="vertical" onFinish={handleFinish}>
        {!propertyId && (
          <Form.Item
            label={t("property_amenity_manage.select_facility")}
            name="propertyId"
            rules={[
              {
                required: true,
          ...
          >
            <Select
              ...
              placeholder={t("property_amenity_manage.select_facility")}
              showSearch
        ...
        <Form.Item label={t("property_amenity_manage.select_amenity")}>
          <Select
            mode="multiple"
            style={{ width: "100%", marginBottom: 20 }}
            placeholder={t("property_amenity_manage.select_amenity")}
        ...
        <Form.Item>
          <Button type="primary" htmlType="submit">
            {t("property_amenity_manage.save")}
          </Button>
        </Form.Item>
      </Form>
    </>
